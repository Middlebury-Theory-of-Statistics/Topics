...
* Two priors centered at $p=0.5$, but one with
    + High prior certainty
    + Low prior certainty
* Two likelihood functions where $\widehat{p}=0.8$ but
    + $n=20$ and $16$ heads
    + $n=100$ and $80$ heads
...
Now let's contrast with the wider prior in red.
...
Now let's contrast with the tighter likelihood in red.
